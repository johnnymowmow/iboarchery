...
1. Upload the iboarchery folder to your wp-content/themes directory
...
or import you own files into `/sass/theme/iboarchery.scss`
...
`/css/iboarchery.min.css` and `/css/iboarchery.css`
